...
<body id ="userFlow">
    ...
    <div class="dropdown">
      <select class="custom-select">
        ...
        <option value="1">First Meal</option>
        <option value="2">Second Meal</option>
        <option value="3">Third Meal</option>
      </select>
    
        <div> <img class ="left-img" src="./images/chicken_brest.png"> </div>
       ...
       <div class="black-dot" data-toggle="modal" data-target="#myModal"><img id="dotNumOne" src="./images/Circle_Icon_1.png"> </div>
        ...
        <div> <img class ="left-img" src="./images/rice.png"> </div>
        <div class="alert alert-success width" role="alert">
            Rice <br> 
            100 gr  
        </div>
        ...
        <div> <img class ="left-img" src="./images/tomato1.png"> </div>
        <div class="alert alert-success width" role="alert">
            Tomato <br> 
            100 gr 
        </div>
        ...
        <div> <img class ="left-img" src="./images/apple1.png"> </div>
        <div class="alert alert-success width" role="alert">
            Apple <br> 
            50 gr 
        </div>
        ...
        <div> <img class ="left-img" src="./images/yogurt.png"> </div>
        <div class="alert alert-success width" role="alert">
            Yogurt <br> 
            70 gr 
        </div>
